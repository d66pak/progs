...
sub Parse::RecDescent::Mail::IMAPClient::Thread::thread
{
    ...
    while (!$_matched && !$commit)
    {
        ...
        unless (defined ($_tok = $thisparser->_parserepeat($text, \&Parse::RecDescent::Mail::IMAPClient::Thread::threadmember, 1, 100000000, $_noactions,undef,$expectation,sub { \@arg })))
        {
...
sub Parse::RecDescent::Mail::IMAPClient::Thread::start
{
    ...
    while (!$_matched && !$commit)
    {
        ...
        unless (defined ($_tok = $thisparser->_parserepeat($text, \&Parse::RecDescent::Mail::IMAPClient::Thread::thread, 0, 100000000, $_noactions,undef,$expectation,sub { \@arg })))
        {
...
sub Parse::RecDescent::Mail::IMAPClient::Thread::threadmember
{
    ...
    while (!$_matched && !$commit)
    {
        ...
        $expectation->is(q{})->at($text);
        unless (defined ($_tok = Parse::RecDescent::Mail::IMAPClient::Thread::NUMBER($thisparser,$text,$repeating,$_noactions,undef,sub { \@arg })))
        {
    ...
    while (!$_matched && !$commit)
    {
        ...
        if (1) { no strict qw{refs};
        $expectation->is(q{})->at($text);
        unless (defined ($_tok = Parse::RecDescent::Mail::IMAPClient::Thread::thread($thisparser,$text,$repeating,$_noactions,undef,sub { \@arg })))
        {
